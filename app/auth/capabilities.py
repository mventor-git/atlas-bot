...
CAPABILITIES: dict[str, tuple[str, str]] = {
    ...
    "review_complaint": ("HQ", "Review complaints"),
    "resolve_complaint": ("HQ", "Resolve complaints"),
    "review_suggestion": ("HQ", "Review suggestions"),
...
ROLE_DEFAULTS: dict[str, frozenset] = {
    ...
    "hr": frozenset({
        ...
        "review_disciplinary_case", "approve_disciplinary_action",
        "review_grievance", "resolve_grievance",
